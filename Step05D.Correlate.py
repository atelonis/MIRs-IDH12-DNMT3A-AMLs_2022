...
mRNA=read_file('NonMutantDatasets/RnaData.txt')
meth=read_file('NonMutantDatasets/MethylationData.txt')
...
write_file('output/Correlation/Step1/NonMutantCorrs.txt',''.join(s))
